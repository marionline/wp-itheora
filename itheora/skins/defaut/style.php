...
.titleon, .titleoff {
	position: absolute;
	top: <?php echo $hvid/2-12;?>px;
/* ou alternativement:
	top: 0px ;
	line-height: <?php echo $hvid-6;?>px; */
...
.big_Ogv, .big_Ogm { background : url(<?php echo $spath; ?>/icones/big_Ogv.png) no-repeat; }
.big_Ogg, .big_Oga { background : url(<?php echo $spath; ?>/icones/big_Ogg.png) no-repeat; }
.big_Torrent { background : url(<?php echo $spath; ?>/icones/big_Torrent.png) no-repeat; }

.Ogv, .Ogg, .Ogm, .Oga, .Srt, .Sub, .Torrent, .Miro, .RSS, .Xspf, .Share_Playlist {
	position : relative;
...
.Ogv a, .Ogg a, .Ogm a, .Oga a, .Srt a, .Sub a, .Torrent a, .Miro a, .RSS a, .Xspf a, .Share_Playlist a { 
	position : absolute;
	width: 24px; height : 24px;
	cursor : move;
}
...
.Ogv, .Ogm { background : url(<?php echo $spath; ?>/icones/Ogv.png) no-repeat; }
.Ogg, .Oga { background : url(<?php echo $spath; ?>/icones/Ogg.png) no-repeat; }
