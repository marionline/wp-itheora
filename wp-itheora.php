...
function wp_itheora_menu() {
    ...
    $page = array();
    $page[] = add_menu_page('itheora', 'itheora', $mincap, basename(__FILE__), 'wp_itheora_infopage', 'http://localhost/~mario/pluginwordpress/wp-content/plugins/wp-itheora/img/fish_theora_org.png');
    $page[] = add_submenu_page(basename(__FILE__), __('Wordpress itheora administration', 'wp-itheora'), __('itheora info', 'wp-itheora'), $mincap, basename(__FILE__), 'wp_itheora_infopage');
    $page[] = add_submenu_page(basename(__FILE__),__('Wordpress itheora administration', 'wp-itheora'), __('Create player', 'wp-itheora'), $mincap, 'wp-itheora/create-player', 'wp_itheora_create_player');
    $page[] = add_submenu_page(basename(__FILE__),__('Wordpress itheora administration', 'wp-itheora'), __('Options', 'wp-itheora'), $mincap, 'wp-itheora/options', 'wp_itheora_config_player');
    
    for($i = 0; $i < count($page); $i++) {
	add_action( "admin_print_scripts-".$page[$i], 'wp_itheora_admin_head' );
    }
}
...
add_action('admin_menu', 'wp_itheora_menu');
